export const modalsQuiz2 = {
  quiz: {
    name: 'Have to, Must, Should - Obligation, Prohibition, Necessity, Advice Quiz',
    questions: [
      {
        question:
          'You _____ brush your teeth twice a day to keep them healthy.',
        options: ['A. have to', 'B. must', 'C. should'],
        answer: 'C',
        description:
          'This sentence is giving advice to brush teeth twice a day for better oral health.',
      },
      {
        question: "I'm sorry, you _____ smoke in here. It's against the law.",
        options: ['A. have to', 'B. must', 'C. should'],
        answer: 'B',
        description:
      ...
      {
        question:
          'We _____ be at the airport by 7:00 am tomorrow for our flight.',
        options: ['A. have to', 'B. must', 'C. should'],
        answer: 'A',
        description:
      ...
      {
        question:
          'You _____ forget to bring your passport when you travel abroad.',
      ...
      {
        question: 'I _____ call my mom tonight to wish her a happy birthday.',
        options: ['A. have to', 'B. must', 'C. should'],
        answer: 'C',
        description:
      ...
      {
        question: 'We _____ use our phones while driving.',
        options: ['A. have to', "B. mustn't", 'C. should'],
        answer: 'B',
        description:
          'This sentence is indicating a prohibition against using phones while driving.',
      },
      {
        question: "I'm feeling sick, so I _____ go to the doctor.",
        options: ['A. have to', 'B. must', 'C. should'],
        answer: 'A',
        description:
      ...
      {
        question:
          "You _____ try this new restaurant, it's supposed to be amazing.",
        options: ['A. have to', 'B. must', 'C. should'],
        answer: 'C',
        description:
